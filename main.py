...
def main():
    ...
    with tempfile.TemporaryDirectory() as local_path:
        if clone_github_repo(github_url, local_path):
            # /python/pyspark/sql/tests/streaming
            index, documents, file_type_counts, filenames = load_and_index_files(local_path + "/hadoop-mapreduce-project/hadoop-mapreduce-examples/src/test/java/org/apache/hadoop/examples  ")
            if index is None:
